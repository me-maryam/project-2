...
<html lang="en">
  <head>
    <title>checkform_Gifterzz</title>
    <meta charset="utf-8">
    ...
    <section class="ftco-section ftco-cart">
        ...
        <form method="post" action="">
            <div class="form-group">
                <input style="border:10px solid black;" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter id" name="id">
            </div>
            <button type="submit" style="background-color:palevioletred;
        height:10px;
        width:30%; text-align:center;"  name="search">Search</button>
        </form>
        <?php
